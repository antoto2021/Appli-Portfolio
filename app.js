...
function openSpotForm(type) {
    ...
    // Si c'est wishlist, on redirige vers le petit modal
    if(type === 'wish') {
        openWishModal();
        return;
    }
    ...
    // Reset
    document.getElementById('spot-id-input').value = ""; // ID vide = création
...
// --- GESTION SECTIONS PERSONNALISÉES (Suite) ---
